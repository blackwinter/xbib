 ...
 */
package org.xbib.io.field.event.reporter;
...
public class TSVFieldEventWriter implements EventListener<MarcFieldEvent> {

    private final static int MAX_EVENTS = 100;

    private final Writer writer;

    private MarcFieldEvent lastEvent;
    ...
    @Override
    public void receive(MarcFieldEvent event) {
