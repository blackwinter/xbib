 ...
 */
package org.xbib.io.field.event;

import org.xbib.io.field.MarcField;

public enum MarcFieldEvent implements Event {
    ...
    FIELD_DROPPED {
        ...
        public MarcFieldEvent setCause(String cause) {
            this.cause = cause;
            return this;
        }
    ...
    RECORD_LABEL_CHANGED {
        private Object prev;
        private Object next;
        public MarcFieldEvent setChange(Object prev, Object next) {
            this.prev = prev;
            this.next = next;
            return this;
        }
    ...
    public MarcFieldEvent setField(MarcField field) {
        this.field = field;
        return this;
    }
    ...
    public MarcFieldEvent setRecordIdentifier(String recordIdentifier) {
