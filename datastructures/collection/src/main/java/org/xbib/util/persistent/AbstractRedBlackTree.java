...
import org.xbib.util.persistent.AbstractRedBlackTree.Node;
...
import static org.xbib.util.persistent.AbstractRedBlackTree.Color.BLACK;
import static org.xbib.util.persistent.AbstractRedBlackTree.Color.RED;
import static org.xbib.util.persistent.AbstractRedBlackTree.Mirror.LEFT;
import static org.xbib.util.persistent.AbstractRedBlackTree.Mirror.RIGHT;

public abstract class AbstractRedBlackTree<K, N extends Node<K, N>, This extends AbstractRedBlackTree<K, N, This>> {

    @SuppressWarnings({"rawtypes","unchecked"})
    private final static Comparator<Comparable> NATURAL = Comparable::compareTo;
    ...
    final This doAdd(UpdateContext<? super N> context, N root, N node) {
        if (root == null) {
            context.insert(node);
