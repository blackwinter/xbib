...
public abstract class AbstractPersistentMapTestHelper<M extends PersistentMap<Integer, Integer>>
        extends AbstractCollectionTestHelper {
    ...
    public void Empty_Map() {
        ...
        assertThat(pmap.asMap(), equalTo((Map<Integer, Integer>) new HashMap<Integer, Integer>()));
    }
    ...
    void assertInsert(Integer... ints) {
        assertInsertAndDelete(Arrays.asList(ints));
    }

    private void assertInsertAndDelete(List<Integer> ints) {
        PersistentMap<Integer, Integer> map = emptyMap();
    ...
    private void assertPersistentMaps(
