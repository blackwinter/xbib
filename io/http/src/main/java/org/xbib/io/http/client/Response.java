...
public interface Response {
    ...
    /**
     * Returns an input stream for the response body. Note that you should not try to get this more than once, and that
     * you should not close the stream.
     *
    ...
    /**
     * Return the request {@link Uri}. Note that if the request got redirected, the value of the {@link Uri} will be the
     * last valid redirect url.
     *
    ...
    /**
     * Return true if the response's headers has been computed by an {@link org.asynchttpclient.AsyncHandler} It will
     * return false if the either
     * {@link org.asynchttpclient.AsyncHandler#onStatusReceived(org.asynchttpclient.HttpResponseStatus)} or {@link
     * org.asynchttpclient.AsyncHandler#onHeadersReceived(org.asynchttpclient.HttpResponseHeaders)} returned {@link
    ...
    /**
     * Return true if the response's body has been computed by an {@link org.asynchttpclient.AsyncHandler}. It will
     * return false if the either {@link org.asynchttpclient.AsyncHandler#onStatusReceived(org.asynchttpclient.HttpResponseStatus)}
     * or {@link org.asynchttpclient.AsyncHandler#onHeadersReceived(org.asynchttpclient.HttpResponseHeaders)} returned
     ...
     *
     * @return remote address client initiated request to, may be {@code null} if asynchronous provider is unable to
     * provide the remote address
     */
     ...
     *
     * @return local address client initiated request from, may be {@code null} if asynchronous provider is unable to
     * provide the local address
     */
