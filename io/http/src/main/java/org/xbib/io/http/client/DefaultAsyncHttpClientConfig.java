...
import org.xbib.io.http.client.proxy.ProxyServerSelector;
import org.xbib.io.http.client.util.ProxyUtils;
...
import static org.xbib.io.http.client.config.AsyncHttpClientConfigDefaults.defaultAcceptAnyCertificate;
import static org.xbib.io.http.client.config.AsyncHttpClientConfigDefaults.defaultChunkedFileChunkSize;
import static org.xbib.io.http.client.config.AsyncHttpClientConfigDefaults.defaultCompressionEnforced;
import static org.xbib.io.http.client.config.AsyncHttpClientConfigDefaults.defaultConnectTimeout;
import static org.xbib.io.http.client.config.AsyncHttpClientConfigDefaults.defaultConnectionTtl;
import static org.xbib.io.http.client.config.AsyncHttpClientConfigDefaults.defaultDisableUrlEncodingForBoundRequests;
import static org.xbib.io.http.client.config.AsyncHttpClientConfigDefaults.defaultDisableZeroCopy;
import static org.xbib.io.http.client.config.AsyncHttpClientConfigDefaults.defaultEnabledProtocols;
import static org.xbib.io.http.client.config.AsyncHttpClientConfigDefaults.defaultFollowRedirect;
import static org.xbib.io.http.client.config.AsyncHttpClientConfigDefaults.defaultHandshakeTimeout;
import static org.xbib.io.http.client.config.AsyncHttpClientConfigDefaults.defaultHttpClientCodecMaxChunkSize;
import static org.xbib.io.http.client.config.AsyncHttpClientConfigDefaults.defaultHttpClientCodecMaxHeaderSize;
import static org.xbib.io.http.client.config.AsyncHttpClientConfigDefaults.defaultHttpClientCodecMaxInitialLineLength;
import static org.xbib.io.http.client.config.AsyncHttpClientConfigDefaults.defaultKeepAlive;
import static org.xbib.io.http.client.config.AsyncHttpClientConfigDefaults.defaultKeepEncodingHeader;
import static org.xbib.io.http.client.config.AsyncHttpClientConfigDefaults.defaultMaxConnections;
import static org.xbib.io.http.client.config.AsyncHttpClientConfigDefaults.defaultMaxConnectionsPerHost;
import static org.xbib.io.http.client.config.AsyncHttpClientConfigDefaults.defaultMaxRedirects;
import static org.xbib.io.http.client.config.AsyncHttpClientConfigDefaults.defaultMaxRequestRetry;
import static org.xbib.io.http.client.config.AsyncHttpClientConfigDefaults.defaultPooledConnectionIdleTimeout;
import static org.xbib.io.http.client.config.AsyncHttpClientConfigDefaults.defaultReadTimeout;
import static org.xbib.io.http.client.config.AsyncHttpClientConfigDefaults.defaultRequestTimeout;
import static org.xbib.io.http.client.config.AsyncHttpClientConfigDefaults.defaultShutdownQuietPeriod;
import static org.xbib.io.http.client.config.AsyncHttpClientConfigDefaults.defaultShutdownTimeout;
import static org.xbib.io.http.client.config.AsyncHttpClientConfigDefaults.defaultSslSessionCacheSize;
import static org.xbib.io.http.client.config.AsyncHttpClientConfigDefaults.defaultSslSessionTimeout;
import static org.xbib.io.http.client.config.AsyncHttpClientConfigDefaults.defaultStrict302Handling;
import static org.xbib.io.http.client.config.AsyncHttpClientConfigDefaults.defaultThreadPoolName;
import static org.xbib.io.http.client.config.AsyncHttpClientConfigDefaults.defaultUseNativeTransport;
import static org.xbib.io.http.client.config.AsyncHttpClientConfigDefaults.defaultUseOpenSsl;
import static org.xbib.io.http.client.config.AsyncHttpClientConfigDefaults.defaultUsePooledMemory;
import static org.xbib.io.http.client.config.AsyncHttpClientConfigDefaults.defaultUseProxyProperties;
import static org.xbib.io.http.client.config.AsyncHttpClientConfigDefaults.defaultUseProxySelector;
import static org.xbib.io.http.client.config.AsyncHttpClientConfigDefaults.defaultUserAgent;
import static org.xbib.io.http.client.config.AsyncHttpClientConfigDefaults.defaultValidateResponseHeaders;
import static org.xbib.io.http.client.config.AsyncHttpClientConfigDefaults.defaultWebSocketMaxBufferSize;
import static org.xbib.io.http.client.config.AsyncHttpClientConfigDefaults.defaultWebSocketMaxFrameSize;

/**
 * Configuration class to use with a {@link org.asynchttpclient.AsyncHttpClient}. System property can be also used to
 * configure this object default behavior by doing: <br>
