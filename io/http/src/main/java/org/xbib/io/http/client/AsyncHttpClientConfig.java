...
import org.xbib.io.http.client.netty.EagerResponseBodyPart;
import org.xbib.io.http.client.netty.LazyResponseBodyPart;
...
public interface AsyncHttpClientConfig {
    ...
    /**
     * Return the name of {@link org.asynchttpclient.AsyncHttpClient}, which is used for thread naming and debugging.
     *
     * @return the name.
     */
    ...
    /**
     * Return the maximum time in millisecond an {@link org.asynchttpclient.AsyncHttpClient} can wait when connecting to
     * a remote host
     *
     * @return the maximum time in millisecond an {@link org.asynchttpclient.AsyncHttpClient} can wait when connecting
     * to a remote host
     */
    ...
    /**
     * Return the maximum time in millisecond an {@link org.asynchttpclient.AsyncHttpClient} will keep connection in
     * pool.
     *
     * @return the maximum time in millisecond an {@link org.asynchttpclient.AsyncHttpClient} will keep connection in
     * pool.
    ...
    /**
     * Return the maximum time in millisecond an {@link org.asynchttpclient.AsyncHttpClient} waits until the response is
     * completed.
     *
     * @return the maximum time in millisecond an {@link org.asynchttpclient.AsyncHttpClient} waits until the response
     * is completed.
     */
     ...
     *
     * @return the {@link ThreadFactory} an {@link AsyncHttpClient} use for handling asynchronous response. If no {@link
     * ThreadFactory} has been explicitly
    ...
    /**
     * Return the number of time the library will retry when an {@link java.io.IOException} is throw by the remote
     * server
     *
     * @return the number of time the library will retry when an {@link java.io.IOException} is throw by the remote
     * server
    ...
    /**
     * In the case of a POST/Redirect/Get scenario where the server uses a 302 for the redirect, should AHC respond to
     * the redirect with a GET or whatever the original method was.
    ...
    /**
     * Return the maximum time in millisecond an {@link org.asynchttpclient.AsyncHttpClient} will keep connection in the
     * pool, or -1 to keep connection while possible.
     *
     * @return the maximum time in millisecond an {@link org.asynchttpclient.AsyncHttpClient} will keep connection in
     * the pool, or -1 to keep connection while possible.
     */
