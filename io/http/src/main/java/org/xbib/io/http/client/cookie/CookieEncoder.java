...
public final class CookieEncoder {
    ...
    /**
     * Sort cookies into decreasing order of path length, breaking ties by sorting into increasing chronological order
     * of creation time, as recommended by RFC 6265.
     */
