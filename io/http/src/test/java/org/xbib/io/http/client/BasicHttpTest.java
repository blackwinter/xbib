...
import org.xbib.io.http.client.request.body.multipart.StringPart;
...
import static org.xbib.io.http.client.test.TestUtils.assertContentTypesEquals;
...
public class BasicHttpTest extends AbstractBasicTest {
    ...
    @Test(groups = "online", expectedExceptions = IllegalArgumentException.class)
