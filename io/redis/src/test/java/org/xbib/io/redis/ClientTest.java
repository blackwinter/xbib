...
import static org.xbib.io.redis.ScriptOutputType.STATUS;
...
import org.xbib.io.redis.protocol.ConnectionWatchdog;
import org.xbib.io.redis.server.RandomResponseServer;
...
public class ClientTest extends AbstractCommandTest {
    ...
    public void requestQueueSize() throws Exception {
        ...
        Channel channel = connection.getChannelWriter().getChannel();
    ...
    public void disconnectedConnectionWithoutReconnect() throws Exception {
        ...
        Channel channel = connection.getChannelWriter().getChannel();
                //(Channel) ReflectionTestUtils.getField(connection.getChannelWriter(), "channel");
        ConnectionWatchdog connectionWatchdog = channel.pipeline().get(ConnectionWatchdog.class);
