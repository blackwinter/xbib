...
import org.xbib.io.redis.models.command.CommandDetail;
import org.xbib.io.redis.models.command.CommandDetailParser;
import org.xbib.io.redis.models.role.RedisInstance;
import org.xbib.io.redis.models.role.RoleParser;
...
public class ServerCommandTest extends AbstractCommandTest {
    ...
    public void debugSegfault() throws Exception {
        final RedisAsyncConnection<String, String> connection = client.connectAsync(RedisURI.Builder.redis(TestSettings.host(), TestSettings.port(3))
                .build());
    ...
    public void role() throws Exception {
        ...
        RedisClient redisClient = new RedisClient(TestSettings.host(), TestSettings.port(1));
    ...
    public void shutdown() throws Exception {
        ...
        final RedisAsyncConnection<String, String> connection = client.connectAsync(RedisURI.Builder.redis(TestSettings.host(), TestSettings.port(4))
                .build());
        try {
