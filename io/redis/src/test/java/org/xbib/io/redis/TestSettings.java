...
public class TestSettings {
    ...
    /**
     *
     * @return unix domain socket name of your redis instance. Defaults to {@literal work/socket-6379}. Can be overriden with
     *         {@code -Ddomainsocket=YourSocket}
     */
    public static String socket() {
        return System.getProperty("domainsocket", "work/socket-6379");
    }
