...
import org.xbib.io.redis.cluster.models.slots.ClusterSlotRange;
import org.xbib.io.redis.cluster.models.slots.ClusterSlotsParser;

import static com.google.code.tempusfugit.temporal.Duration.seconds;
import static com.google.code.tempusfugit.temporal.Timeout.timeout;
import static org.xbib.io.redis.cluster.ClusterTestUtil.getNodeId;
import static org.xbib.io.redis.cluster.ClusterTestUtil.getOwnPartition;
...
public class RedisClusterClientTest extends AbstractClusterTest {
    ...
    public void testClusterFailover() throws Exception {
        ...
        if (redis1Node.getFlags().contains(RedisClusterNode.NodeFlag.MASTER)) {
            ...
            log.info("Cluster nodes seen from node 1: " + redissync1.clusterNodes());
            ...
            log.info("Cluster nodes seen from node 1 after clusterFailover: " +  redissync1.clusterNodes());
            log.info("Cluster nodes seen from node 4 after clusterFailover: " + redissync4.clusterNodes());
