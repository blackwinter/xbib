...
public class ClusterPartitionParserTest {
    ...
    public void testParse() throws Exception {
        ...
        assertThat(p1.getSlots()).contains(7000);
        assertThat(p1.getSlots()).contains(12000);
        assertThat(p1.getSlots()).contains(12002);
        assertThat(p1.getSlots()).contains(12003);
        assertThat(p1.getSlots()).contains(16383);
