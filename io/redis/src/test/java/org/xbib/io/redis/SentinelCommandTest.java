...
public class SentinelCommandTest extends AbstractCommandTest {
    ...
    public void openConnection() throws Exception {
        ...
        try {
            ...
            sentinelRule.monitor(MASTER_ID, TestSettings.hostAddr(), TestSettings.port(3), 1, true);
        }
    }
    ...
    public void getMaster() throws Exception {
        ...
        assertThat(result.get("ip")).isEqualTo(TestSettings.hostAddr()); // !! IPv4/IPv6
    ...
    public void monitor() throws Exception {
        ...
        String result = sentinel.monitor("mymaster2", TestSettings.hostAddr(), 8989, 2).get();
