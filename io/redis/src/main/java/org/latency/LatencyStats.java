...
import org.histogram.AtomicHistogram;
import org.histogram.Histogram;
import org.histogram.WriterReaderPhaser;
 ...
 * (see {@link org.histogram.Histogram}).
 * <p>
 ...
 * using the fluent API builder supported by {@link Builder}.
 *
 ...
 * instance of {@link org.latency.SimplePauseDetector}, which uses consensus observation
 * of a pause across multiple observing threads as a detection technique.
 *
 * Custom pause detectors can be provided (by subclassing {@link org.latency.PauseDetector}).
 ...
 * (which {@link org.latency.SimplePauseDetector} is built to detect).
 *
