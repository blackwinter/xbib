...
import org.xbib.io.redis.AbstractRedisClient;
...
import org.xbib.io.redis.cluster.event.ClusterTopologyChangedEvent;
...
import static org.xbib.io.redis.cluster.ClusterTopologyRefresh.RedisUriComparator.INSTANCE;
...
public class RedisClusterClient extends AbstractRedisClient {
    ...
    private static final Logger logger = LogManager.getLogger(RedisClusterClient.class);
