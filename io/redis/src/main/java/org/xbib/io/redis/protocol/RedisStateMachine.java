...
import static org.xbib.io.redis.protocol.RedisStateMachine.State.Type.INTEGER;
import static org.xbib.io.redis.protocol.RedisStateMachine.State.Type.MULTI;
import static org.xbib.io.redis.protocol.RedisStateMachine.State.Type.SINGLE;
...
public class RedisStateMachine<K, V> {
    private static final Logger logger = LogManager.getLogger(RedisStateMachine.class);
