...
public class ChannelSession extends AbstractServerChannel {
    ...
    protected Result handleAgentForwarding(Buffer buffer, boolean wantReply) throws IOException {
    ...
    protected Result handleX11Forwarding(Buffer buffer, boolean wantReply) throws IOException {
        ServerSession session = getServerSession();
