...
public class GzipSourceTest {
    ...
    public void gunzip_withExtra() throws Exception {
        ...
        gzipped.write("blubber".getBytes(StandardCharsets.UTF_8), 0, 7);
        gzipped.write(deflated);
        gzipped.write(gzipTrailer);
        assertGzipped(gzipped);
    }
    ...
    public void gunzip_withName() throws Exception {
        ...
        gzipped.write("foo.txt".getBytes(StandardCharsets.UTF_8), 0, 7);
    ...
    public void gunzip_withComment() throws Exception {
        ...
        gzipped.write("rubbish".getBytes(StandardCharsets.UTF_8), 0, 7);
        gzipped.writeByte(0); // zero-terminated
        gzipped.write(deflated);
        gzipped.write(gzipTrailer);
        assertGzipped(gzipped);
    ...
    public void gunzipExhaustsSource() throws Exception {
        ...
        BufferedSource gunzippedSource = IO.buffer(new GzipSource(exhaustableSource));
    ...
    public void gunzipThrowsIfSourceIsNotExhausted() throws Exception {
        ...
        BufferedSource gunzippedSource = IO.buffer(new GzipSource(gzippedSource));
