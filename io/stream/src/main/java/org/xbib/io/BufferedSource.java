...
public interface BufferedSource extends Source {
    ...
    /**
     * Removes bytes until delimiter is read, returns them as byte array.
     * @param delimiter delimiter
     * @return byte array
     * @throws EOFException
     */
    byte[] readToDelimiter(byte delimiter) throws EOFException;
    ...
    /**
     * Removes all bytes from this until appearance of byte {@code b}
     * and appends them to {@code sink}. Returns the
     * total number of bytes written to {@code sink} which will be 0 if there is
     * no appearance of byte {@code b}.
     */
    long readToDelimiter(Sink sink, byte b, long fromIndex) throws IOException;
