...
public class PeriodFormatterBuilder {
    ...
    private void appendField(ChronoUnit unit, int minPrinted) {
        FieldFormatter field = new FieldFormatter(minPrinted, /*iPrintZeroSetting,*/
            iMaxParsedDigits, iRejectSignedValues, unit, /*iFieldFormatters,*/ iPrefix, null);
        append0(field, field);
    ...
    static class FieldFormatter implements PeriodPrinter, PeriodParser {
        ...
        FieldFormatter(int minPrintedDigits, //int printZeroSetting,
                       ...
                       ChronoUnit chronoUnit, //FieldFormatter[] fieldFormatters,
