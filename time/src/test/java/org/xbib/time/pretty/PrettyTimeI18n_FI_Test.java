...
public class PrettyTimeI18n_FI_Test {
    ...
    public void testSecondFromNow() throws Exception {
        PrettyTime t = newPrettyTimeWOJustNow(new Date(0), locale);
        assertEquals("sekunnin päästä", t.format(new Date(1000)));
    }

    @Test
    public void testSecondAgo() throws Exception {
        PrettyTime t = newPrettyTimeWOJustNow(new Date(1000), locale);
    ...
    public void testMinuteFromNow() throws Exception {
        PrettyTime t = newPrettyTimeWOJustNow(new Date(0), locale);
        assertEquals("minuutin päästä", t.format(new Date(1000 * 60)));
    }

    @Test
    public void testMinuteAgo() throws Exception {
        PrettyTime t = newPrettyTimeWOJustNow(new Date(1000 * 60), locale);
    ...
    public void testHoursFromNowSingle() throws Exception {
        PrettyTime t = new PrettyTime((0), locale);
        assertEquals("tunnin päästä", t.format(new Date(1000 * 60 * 60)));
    }
    ...
    public void testDaysFromNowSingle() throws Exception {
        PrettyTime t = new PrettyTime(0, locale);
        assertEquals("huomenna", t.format(new Date(1000 * 60 * 60 * 24)));
    }
    ...
    public void testWeeksFromNowSingle() throws Exception {
        PrettyTime t = new PrettyTime((0), locale);
        assertEquals("viikon päästä", t.format(new Date(1000 * 60 * 60 * 24 * 7)));
    }
    ...
    public void testMonthFromNow() throws Exception {
        PrettyTime t = new PrettyTime(0, locale);
        assertEquals("kuukauden päästä", t.format(new Date(1000L * 60 * 60 * 24 * 30)));
    }
    ...
    public void testYearFromNow() throws Exception {
        PrettyTime t = new PrettyTime((0), locale);
        assertEquals("vuoden päästä", t.format(new Date(1000L * 60 * 60 * 24 * 366)));
    }
    ...
    public void testDecadeFromNow() throws Exception {
        PrettyTime t = new PrettyTime((0), locale);
        assertEquals("vuosikymmenen päästä", t.format(new Date(1000L * 60 * 60 * 24 * 365 * 11)));
    }
