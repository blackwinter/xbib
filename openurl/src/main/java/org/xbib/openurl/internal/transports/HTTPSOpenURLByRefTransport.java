 ...
 */
public class HTTPSOpenURLByRefTransport extends HTTPOpenURLByRefTransport {

    /**
     * Construct an HTTPS OpenURL By-Ref Transport object
     *
     * @param config
     */
    public HTTPSOpenURLByRefTransport(OpenURLConfig config) {
        super(config);
    }

    @Override
    public URI getTransportID() {
        return Transport.HTTPS_OPENURL_BY_REF_URI;
    }
