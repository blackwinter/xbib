...
public class InvalidXmlCharacterFilterReader extends FilterReader {
    ...
    public InvalidXmlCharacterFilterReader(InputStream in, String encoding) throws UnsupportedEncodingException {
    ...
    private char filter(char ch) {
        return ch < 0x20 && ch != 0x09 && ch != 0x0a && ch != 0x0d ? 0x20 : ch;
    }
