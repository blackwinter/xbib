 ...
 */
public class MABDisketteCarriageReturnLineFeedStreamReader extends CarriageReturnLineFeedStreamReader {

    private FieldListener listener;

    public MABDisketteCarriageReturnLineFeedStreamReader(Reader reader, FieldListener listener) {
        super(reader);
