 ...
 * ticks for date axes
 */
public class AxisTickCalculatorDate extends AxisTickCalculator {
     ...
     * @param styler
     */
    public AxisTickCalculatorDate(Direction axisDirection, double workingSpace, double minValue, double maxValue, StylerAxesChart styler) {
