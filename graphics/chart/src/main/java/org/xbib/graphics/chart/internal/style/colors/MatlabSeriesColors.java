...
public class MatlabSeriesColors implements SeriesColors {
    ...
    public final static Color TURQUOISE = new Color(0, 191, 191, 255);
    public final static Color MAGENTA = new Color(191, 0, 191, 255);
    public final static Color YELLOW = new Color(191, 191, 0, 255);
    public final static Color DARK_GREY = new Color(64, 64, 64, 255);
