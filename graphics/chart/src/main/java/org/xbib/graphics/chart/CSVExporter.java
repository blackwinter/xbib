...
/**
 * This class is used to export Chart data to a folder containing one or more CSV files. The parent folder's name is the
 * title of the chart. Each
...
public class CSVExporter {
     ...
     */
    public static void writeCSVRows(SeriesAxesChart series, String path2Dir) {
     ...
     * @param path2Dir - ex. "./path/to/directory/" *make sure you have the '/' on the end
     */
    public static void writeCSVColumns(SeriesAxesChart series, String path2Dir) {
