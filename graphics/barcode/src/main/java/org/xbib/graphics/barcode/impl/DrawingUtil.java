...
public class DrawingUtil {
     ...
     */
    public static void drawCenteredChar(Canvas canvas, AbstractBarcodeGenerator bean,
                                    char ch, 
     ...
     * @param x2 the right boundary
     * @param y1 the y coordinate of the font's baseline
     * @deprecated Use {@link #drawText(Canvas, AbstractBarcodeGenerator, String, double, double, double, TextAlignment)} instead.
     */
    public static void drawJustifiedText(Canvas canvas, AbstractBarcodeGenerator bean,
                                    String text, 
                                    double x1, double x2, double y1) {
     ...
     * @deprecated Use {@link #drawText(Canvas, AbstractBarcodeGenerator, String, double, double, double, TextAlignment)} instead.
     */
    public static void drawCenteredText(Canvas canvas, AbstractBarcodeGenerator bean,
                                    String text, 
                                    double x1, double x2, double y1) {
