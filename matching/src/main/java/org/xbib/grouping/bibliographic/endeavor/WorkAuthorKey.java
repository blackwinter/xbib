 ...
 */
public class WorkAuthorKey implements IdentifiableEndeavor {
    ...
    public WorkAuthorKey() {
    }

    public WorkAuthorKey workName(CharSequence workName) {
        if (workName != null) {
    ...
    public WorkAuthorKey authorName(Collection<String> authorNames) {
     ...
     * @return this
     */
    public WorkAuthorKey authorName(String authorName) {
        if (authorName == null) {
            return this;
        }
    ...
    public WorkAuthorKey authorNameWithForeNames(String lastName, String foreName) {
        if (foreName == null) {
     ...
     */
    public WorkAuthorKey authorNameWithInitials(String lastName, String initials) {
        if (initials != null) {
    ...
    public WorkAuthorKey chronology(String chronology) {
        if (chronology != null) {
