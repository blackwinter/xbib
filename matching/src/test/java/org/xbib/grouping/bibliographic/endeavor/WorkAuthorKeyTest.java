...
public class WorkAuthorKeyTest extends Assert {

    @Test
    public void test() throws Exception {
        assertFalse(new WorkAuthorKey().blacklist().isEmpty());
    }

    @Test
    public void testAuthor() throws Exception {
        String workAuthor = new WorkAuthorKey().authorName("Jörg Prante").workName("Hello World").createIdentifier();
        assertEquals(workAuthor, "wHeoWrD.aPranteJ");
    }

    @Test
    public void testAuthorForeName() throws Exception {
        String workAuthor = new WorkAuthorKey().authorNameWithForeNames("Prante", "Jörg").workName("Hello World").createIdentifier();
        assertEquals(workAuthor, "wHeoWrD.aPranteJ");
    }

    @Test
    public void testAuthorInitials() throws Exception {
        String workAuthor = new WorkAuthorKey().authorNameWithInitials("Prante", "J").workName("Hello World").createIdentifier();
        assertEquals(workAuthor, "wHeoWrD.aPranteJ");
    }

    @Test
    public void testMedline() throws Exception {
        String workAuthor = new WorkAuthorKey()
